<template>
  ...
  >
    ...
    >
      ...
      <div class="flex flex-col gap-1.5">
        <button
          ...
          :key="opt.value"
          type="button"
          :aria-pressed="localMode === opt.value"
          ...
          <Transition name="slide-down">
            ...
            >
              ...
              <input
                ...
                max="20"
                step="1"
                :aria-label="`Re-inject every ${localInterval} ${localInterval === 1 ? 'message' : 'messages'}`"
    ...
    >
      ...
      <div class="flex gap-1.5">
        <button
          ...
          :key="pos.value"
          type="button"
          :aria-pressed="localPosition === pos.value"
    ...
    <div
      ...
      role="group"
      aria-labelledby="label-conversation-behaviour"
      class="flex flex-col gap-2"
    >
      <span
...
const localMode = ref<PromptInjectionMode>(props.mode)

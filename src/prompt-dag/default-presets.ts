...
export const DEFAULT_PRESETS: PromptPresetPOJO[] = [
  ...
  // Tools — requiredCapabilities is intentionally omitted here;
  // DagBuilder.addPreset() reads caps from the PromptRegistry part, not from the preset.
  { presetId: 'use_file_tools',            id: 'file_tool',              category: 'tools',     defaultEnabled: true,  repeat: 1, description: 'Use file system tools for file operations.' },
  { presetId: 'web_research',              id: 'research',               category: 'tools',     defaultEnabled: false, repeat: 1, description: 'Search for latest AI trends.' },
  // Format
  ...
  { presetId: 'output_toon',               id: 'format_toon_example',    category: 'format',    defaultEnabled: false, repeat: 1, description: 'Respond using TOON (Token-Oriented Object Notation).' },
  // Diagrams
  { presetId: 'mermaid_dark_purple_theme', id: 'mermaid_dark_purple',    category: 'diagrams',  defaultEnabled: false, repeat: 1, description: 'Use WCAG-compliant dark+purple Mermaid theme.' },
  // Files
  { presetId: 'respect_gitignore',         id: 'ignore_gitignore',       category: 'files',     defaultEnabled: true,  repeat: 1, description: 'Never read or reference .gitignore-listed files.' },
  // Audience
  { presetId: 'explain_eli5',              id: 'eli5',                   category: 'audience',  defaultEnabled: false, repeat: 1, description: 'Explain as if to a 5-year-old.' },
  { presetId: 'explain_eli14',             id: 'eli14',                  category: 'audience',  defaultEnabled: false, repeat: 1, description: 'Explain as if to a 14-year-old student.' },
]

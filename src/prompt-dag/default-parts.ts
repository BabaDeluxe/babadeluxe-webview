...
export const DEFAULT_PROMPT_PARTS: PromptPartPOJO[] = [
  ...
  { id: 'mermaid_dark_purple',  content: 'When producing Mermaid diagrams, always use the dark+purple theme configuration with WCAG 7.0 contrast, renderable on GitHub.' },
